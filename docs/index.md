...
<div class="services">
    <a href="https://cartanatal.de/servicios" class="coffee-btn">✨ Solicitar Carta Natal Personificada</a>
    <a href="https://cartanatal.de/servicios" class="coffee-btn">📖 Preinscripción a Cursos (Formulario de Contacto)</a>
    <a href="https://cartanatal.de/servicios" class="coffee-btn">☕ Invita a un café pequeño, mediano o grande como forma de apoyo para mantener la web.</a>
    </div>
...
<div style="text-align:center; margin: 3rem 0;">
    ...
    <a href="https://cartanatal.de/contacto" class="btn-hero" style="background: linear-gradient(90deg, #8B5CF6, #F472B6);">✉️ Ir a contacto</a>
